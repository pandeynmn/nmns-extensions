...
class Madara extends paperback_extensions_common_1.Source {
    constructor() {
         ...
         * which is looped over. This may be overridden if required.
         */
        this.chapterDetailsSelector = '.page-break.no-gaps > img';
        /**
    ...
    getHomePageSections(sectionCallback) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const json = yield this.getJsonData(this, 'https://pandeynmn.github.io/rs.html');
            const sections = [
                {
                ...
                },
                {
                    ...
                    section: createHomeSection({
                        id: 'dev-titles',
                        title: (_a = json.heading) !== null && _a !== void 0 ? _a : 'Error Github',
                        view_more: false,
                ...
                },
                {
                    ...
                    section: createHomeSection({
                        id: 'coming-soon',
                        title: 'Coming Soon' !== null && 'Coming Soon' !== void 0 ? 'Coming Soon' : 'Error Github',
                        view_more: false,
            ...
            for (const section of sections) {
                ...
                promises.push(this.requestManager.schedule(section.request, 1).then((response) => {
                    ...
                    section.section.items = this.parser.parseHomeSection($, this, section.section.id);
                    sectionCallback(section.section);
                }));
            }
    ...
    getViewMoreItems(homepageSectionId, metadata) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.CloudFlareError(data.status);
            const $ = this.cheerio.load(data.data);
            const items = this.parser.parseHomeSection($, this, homepageSectionId);
...
class Parser {
    constructor() {
        // Novel array for the movement is hard coded because of a limited number of novels
        // To be automated in the future through the novel page on the website
    ...
    parseChapterList($, mangaId, source) {
        ...
        for (const obj of $('li.wp-manga-chapter').toArray()) {
            const id = (_a = ($('a', $(obj)).first().attr('href') || '').split('/')[5]) !== null && _a !== void 0 ? _a : '';
    ...
    parseSearchResults($, source) {
        ...
        for (const obj of $(source.searchMangaSelector).toArray()) {
            const id = (_b = ((_a = $('a', $(obj)).attr('href')) !== null && _a !== void 0 ? _a : '').split('/')[4]) !== null && _b !== void 0 ? _b : '';
            const title = createIconText({ text: this.decodeHTMLEntity((_c = $('a', $(obj)).attr('title')) !== null && _c !== void 0 ? _c : '') });
    ...
    parseHomeSection($, source, sectionId) {
        var _a, _b, _c;
        const items = [];
        if (sectionId == 'dev-titles')
            return this._githubTitleParse($);
        ...
        for (const obj of $('div.page-item-detail').toArray()) {
            ...
            let id = (_b = $('a', $('h3.h5', $(obj)))
                .attr('href')) === null || _b === void 0 ? void 0 : _b.replace(`${source.baseUrl}/${source.sourceTraversalPathName}/`, '').replace(/\/$/, '');
            ...
            id = (_c = id.split('/')[4]) !== null && _c !== void 0 ? _c : '';
            if (this._novelArr.includes(id))
                continue;
    ...
    _githubTitleParse($) {
        ...
        for (const obj of json.seriesList) {
            items.push(createMangaTile({
